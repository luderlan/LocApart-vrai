...
<body>
    <header>
        ...
        */
        ...
        <div class="navbar">
            <a href="../../../interface/connecter.html" class="user"><i class="fa-regular fa-user" style="color: #1b5eaf;"></i> Se Connecter</a>
